 ...
 * 
 * @export
 * @interface ReleaseUpdateParameters1
 */
export interface ReleaseUpdateParameters1 {
    /**
     * Cron schedule for the scheduler. Read more about the format of this field at https://en.wikipedia.org/wiki/Cron
     * @type {string}
     * @memberof ReleaseUpdateParameters1
     */
    cronSchedule?: string;
    /**
...
export function ReleaseUpdateParameters1FromJSON(json: any): ReleaseUpdateParameters1 {
    return ReleaseUpdateParameters1FromJSONTyped(json, false);
}

export function ReleaseUpdateParameters1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ReleaseUpdateParameters1 {
...
export function ReleaseUpdateParameters1ToJSON(value?: ReleaseUpdateParameters1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
