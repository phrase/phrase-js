...
export function DistributionUpdateParametersFromJSON(json: any): DistributionUpdateParameters {
    return DistributionUpdateParametersFromJSONTyped(json, false);
}

export function DistributionUpdateParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): DistributionUpdateParameters {
...
export function DistributionUpdateParametersToJSON(value?: DistributionUpdateParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
